...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: '', title: 'Dashboard', icon: 'ft-home', class: '', badge: '', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: [
 ...
 /* {
  ...
  {
    path: '/tables/basic', title: ' Planning Remorques', icon: 'ft-grid', class: '', badge: '', badgeClass: '', isExternalLink: false,
    submenu: [
  ...
  {
    path: '/datatables', title: 'Remorques', icon: 'ft-layout', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
  },
  {
    path: '/cards/advanced', title: 'Quai', icon: 'ft-layers', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [
  ...
  {
    path: '/charts/apex', title: 'Graphiques', icon: 'ft-bar-chart-2', class: '', badge: '', badgeClass: 'badge badge-pill badge-success float-right mr-1 mt-1', isExternalLink: false,
   submenu: [],
   ...
   // ]
     ...
     // {
       // path: '', title: 'Users', icon: 'ft-arrow-right submenu-icon', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false,
          ...
          { path: '/pages/users-list', title: 'Utilisateurs', icon: 'ft-users', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
